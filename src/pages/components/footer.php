        ...
        <div class="container footer-container">
            ...
            <div class="footer-info">
                <div class="footer-info__app">
                    <div class="footer-info__app-title">Скачайте мобильное приложение</div>
                    <div class="footer-info__app-list">
                        <a href="javascript:;" class="footer-info__app-link" target="_blank" title="App Store">
                            <img
                                loading="lazy"
                                class="image"
            ...
            <div class="footer-app-mobile">
                <div class="footer-app-mobile__title">Мобильное приложение</div>
                <div class="footer-app-mobile__list">
                    <a href="javascript:;" class="footer-app-mobile__link" target="_blank">
                        <img
                            loading="lazy"
                            class="image"
                            src="img/app-appstore-mob.svg"
                            height="40"
                            alt="Изображение блока"
                        >
                    </a>
                    <a href="javascript:;" class="footer-app-mobile__link" target="_blank">
                        <img
                            loading="lazy"
                            class="image"
                            src="img/app-googleplay-mob.svg"
                            height="40"
                            alt="Изображение блока"
                        >
                    </a>
    ...
    <br>
    <br>
    ниже копия с материк
    <br>
    <br>
    <footer class="footer-new">
        <div class="footer-new__subscribe">
            <div class="inner">
                <div class="prod_has_error"><a class="js-call-popup" href="javascript:;"><img src="img/has-error.png"> Hашли ошибку? - Напишите нам</a></div>
                    ...
                    <div class="subscribe-new">
                        ...
                        <div class="subscribe-new__form">
                            <form id="asd_subscribe_form" action="/" method="post" class="form-subscribe-new">
                                <input type="hidden" name="sessid" id="sessid" value="9a97b275a124be74744f9c869710d3ac">					<input type="hidden" name="asd_subscribe" value="Y">
                                <input type="hidden" name="charset" value="UTF-8">
                                <input type="hidden" name="site_id" value="s1">
                                <input type="hidden" name="asd_rubrics" value="1">
                                <input type="hidden" name="asd_show_rubrics" value="N">
                                <input type="hidden" name="asd_not_confirm" value="Y">
                                <input type="hidden" name="asd_key" value="942d0498d2f1d1f2436f621a4b616005">
                            ...
                            <ul class="mobile-apps-new__list">
                                <li class="mobile-apps-new__item">
                                    <a href="https://redirect.appmetrica.yandex.com/serve/100287002154382212" target="_blank" class="mobile-apps-new__link">
                                        <img src="img/app-appstore.svg" alt="" class="mobile-apps-new__bage">
                                    </a>
                                </li>
                                <li class="mobile-apps-new__item">
                                    <a href="https://redirect.appmetrica.yandex.com/serve/100287002154382212" target="_blank" class="mobile-apps-new__link">
                                    ...
                                    <div class="footer-contacts__item">
                                        <div class="footer-contacts__item-map-wrap">
                                            <div class="footer-contacts__map">
                                                <div class="footer-contacts__map-container" id="contacts-map-small-yakornaya" style=""></div>
                                            </div>
                                        </div>
                            ...
                            <div class="footer-contacts__col col col-4">
                                <div class="footer-contacts__item-wrap">
                                    <div class="footer-contacts__item">
                                        <div class="footer-contacts__item-map-wrap">
                                            <div class="footer-contacts__map">
                                                <div class="footer-contacts__map-container" id="contacts-map-small-narvskaya" style=""></div>
                                            </div>
                                        </div>
                                        <div class="footer-contacts__item-info-wrap">
                            ...
                            <div class="footer-contacts__col col col-4">
                                <div class="footer-contacts__item-wrap">
                                    <div class="footer-contacts__item">
                                        <div class="footer-contacts__item-map-wrap">
                                            <div class="footer-contacts__map">
                                                <div class="footer-contacts__map-container" id="contacts-map-small-vasileostrovskaya" style=""></div>
                                            </div>
                                        </div>
                                        <div class="footer-contacts__item-info-wrap">
                                ...
                                <div class="footer-info__app-links-apps-wrap">
                                    ...
                                    <div class="footer-info__app-row">
                                        <div class="footer-info__app-col">
                                            <a href="https://redirect.appmetrica.yandex.com/serve/100287002154382212" target="_blank" class="footer-info__app-item">
                                                <img src="img/app-appstore.svg" class="footer-info__app-icon" alt="App Store">
                                            </a>
                                        </div>
                                        <div class="footer-info__app-col">
                                            <a href="https://redirect.appmetrica.yandex.com/serve/100287002154382212" target="_blank" class="footer-info__app-item">
                                                <img src="img/app-googleplay.svg" class="footer-info__app-icon" alt="Google Play">
                                            </a>
                                        </div>
                                        <div class="footer-info__app-col footer-info__app-col--qr">

                                            <span class="footer-info__app-item">
                                                <img src="img/app-qrcode.png" class="footer-info__app-icon" alt="QR" width="100">
                                            </span>
