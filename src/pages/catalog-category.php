                ...
                <div class="cp-content__item cp-content__top">
                        ...
                        <div class="cp-content__sort">
                            ...
                            <div class="cp-content__sort-options">
                                <div class="cp-content__sort-item">
                                    ...
                                    <label for="sort0" class="cp-content__sort-label desc active">
                                        <span class="text-content">По цене</span>
                                    </label>
                                </div>
                                <div class="cp-content__sort-item">
                                    <input id="sort1" type="radio" class="visually-hidden" name="sortCatalogCategory" value="">
                                    <label for="sort1" class="cp-content__sort-label asc">
                                        <span class="text-content">По названию</span>
                                    </label>
                                </div>
                                <div class="cp-content__sort-item">
                                    <input id="sort2" type="radio" class="visually-hidden" name="sortCatalogCategory" value="">
                                    <label for="sort2" class="cp-content__sort-label desc">
                                        <span class="text-content">По скидке</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cp-content__filter-selected" data-filter-selected>
                        <button class="btn-reset btn btn-secondary cp-content__filter-selected-item" data-removable>
                            <span class="text-content">до 5000 ₽</span>
                        ...
                        <button class="btn-reset btn btn-secondary cp-content__filter-selected-item" data-removable>
                            <span class="text-content">Дорнит ГЕО</span>
                            <span class="cp-content__filter-selected-extra">+2</span>
                            <span class="cp-content__filter-selected-delete" data-delete-trigger>
                                <svg class="icon icon-fill">
                                    <use href="img/sprite.svg#cross"></use>
                                </svg>
                        ...
                        <button class="btn-reset btn btn-secondary cp-content__filter-selected-item" data-removable>
                            <span class="text-content">Тканный</span>
                            <span class="cp-content__filter-selected-delete" data-delete-trigger>
                                <svg class="icon icon-fill">
                                    <use href="img/sprite.svg#cross"></use>
                                </svg>
                        ...
                        <button class="btn-reset btn btn-secondary cp-content__filter-selected-item" data-removable>
                            <span class="text-content">Ширина 1 — 2 м</span>
                            <span class="cp-content__filter-selected-delete" data-delete-trigger>
                                <svg class="icon icon-fill">
                                    <use href="img/sprite.svg#cross"></use>
                                </svg>
